...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden',
...
const SelectScrollUpButton = ({
  ...
  <SelectPrimitive.ScrollUpArrow
    ...
    className={cn(
      ...
      'bg-popover py-1 [&_svg:not([class*=\'size-\'])]:size-4',
      className,
    )}
    {...props}
  >
...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'py-2 pr-2 pl-2.5 text-sm whitespace-nowrap transition-colors',
      ...
      'data-placeholder:text-muted-foreground data-[size=default]:h-8',
